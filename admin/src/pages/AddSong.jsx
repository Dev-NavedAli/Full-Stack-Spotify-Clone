    ...
    <form onSubmit={onSubmitHandler} className='flex flex-col items-start gap-8 text-gray-600'>
      <div className="flex gap-8">
        ...
        <div className='flex flex-col gap-4 '>
          ...
          <label htmlFor="image">
            <img src={image ? URL.createObjectURL(image) : assets.upload_area} className='w-24 cursor-pointer' alt="" />{/* URL.createObjectURL(image) ki help se jo selcted image hoga vo after selection show hoga */}
          </label>
        </div>
      </div>
